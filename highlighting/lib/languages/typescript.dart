...
final typescript = Language(
  ...
  refs: {
    ...
    '~contains~13~contains~0': Mode(
      ...
      contains: [
        ...
        ModeReference('~exports~PARAMS_CONTAINS~12~0'),
        ModeReference('~exports~PARAMS_CONTAINS~12~1'),
        ModeReference('~exports~PARAMS_CONTAINS~12~2'),
      ],
    ),
  },
  name: "TypeScript",
  ...
  contains: [
    ...
    Mode(
      ...
      contains: [ModeReference('~exports~PARAMS_CONTAINS~12~0')],
    ),
    ModeReference('~exports~PARAMS_CONTAINS~12~2'),
  ],
);
